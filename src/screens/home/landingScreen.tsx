...
const LandingScreen = (props: any) => {
  ...
  const [showCirclesView,setCirclesView] = useState(isLoggedIn ? true : false);

  useEffect(() => {
   setCirclesView(isLoggedIn);
  }, [isLoggedIn]);
  ...
  return (
    <ScrollView contentContainerStyle={styles.screen}>
      ...
      <View style={styles.body}>
        {!showCirclesView ? (
          <>
            <View style={{...styles.cantFind, marginVertical:30}}>
            ...
            <View style={{...styles.cantFind, marginBottom:30}}>
              <Text style={styles.cantFindTitle}>Create a new account</Text>
              <TouchableOpacity
                activeOpacity={0.5}
                style={styles.cantFindAcion}
                onPress={() => setCirclesView(true)} //props.navigation.navigate("LandingScreen")}
              >
          ...
          <>
            <AllCirclesComponent {...props} />
            <View style={styles.moreConditions}>
              <Text style={styles.moreConditionsText}>
                More conditions comming soon
              </Text>
            </View>
            <View style={styles.cantFind}>
              ...
              <Text style={styles.cantFindDesc}>
                Send us a message if you want to see MyHealthCircles work on
              ...
              <TouchableOpacity
                ...
                style={styles.cantFindAcion}
                onPress={() =>
                  props.navigation.navigate("Contact", { screen: "ContactUs" })
                }
              >
                <Text style={styles.cantFindAcionText}>Contact us</Text>
              </TouchableOpacity>
            </View>
          </>
        )}
